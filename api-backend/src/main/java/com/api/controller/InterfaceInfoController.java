...
import com.api.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Long> addInterfaceInfo(@RequestBody InterfaceInfoAddRequest interfaceInfoAddRequest, HttpServletRequest request) {
        ...
        interfaceInfo.setUser_id(loginUser.getId());
    ...
    public BaseResponse<Boolean> deleteInterfaceInfo(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldInterfaceInfo.getUser_id().equals(user.getId()) && !userService.isAdmin(request)) {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest, HttpServletRequest request) {
        ...
        Gson gson=new Gson();
        com.api.apiclientsdk.model.User user = gson.fromJson(requestParams, com.api.apiclientsdk.model.User.class);
